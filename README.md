...
## Toolforge setup
```shell
rm -fdr $HOME/repo && git clone --depth 1 --single-branch https://github.com/jjmc89-bot/nfcbot $HOME/repo && toolforge-jobs run setup-venv --command $HOME/repo/.toolforge/bin/setup-venv --image python3.13 --wait && toolforge-jobs load $HOME/repo/.toolforge/cronjobs.yaml
```
